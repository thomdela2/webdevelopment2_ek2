...
<div class="section section-form">
    <form class="edit" action="{{ route('register.save') }}" method="post">
        ...
        <input class="p light" type="text" name="email" placeholder="{{__('Emailaddress')}}">
        <input class="p light" type="text" name="password" placeholder="{{__('Password')}}">
        <input class="p light" type="text" name="role" placeholder="{{__('Role')}}">

        <div class="buy-btn">
            <input class="btn" type="submit" value="{{__('Register')}}">
        </div>
    {{-- <a href="{{ route('password.request') }}" class="p light">{{__('Forgot my password')}}</a> --}}
